...
export default function MobileTopBar({ activeTopic, onOpenDrawer }: MobileTopBarProps) {
  return (
    <div className="md:hidden bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-between sticky top-0 z-20">
      <button
        onClick={onOpenDrawer}
        className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 active:opacity-70"
      >
